...
// FinFlow Colors
//val PrimaryBlue = Color(0xFF1E2B7A)
//val SecondaryBlue = Color(0xFF161C4C)
//val LinkTeal = Color(0xFF00897B)
//val TextFieldBackground = Color(0xFFF1F4F9)
//val GrayText = Color(0xFF667085)
//val White = Color(0xFFFFFFFF)
val Primary = Color(0xFF2E3192)             // Índigo principal
